...
export class AddClassIdToAssignments1764774000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (indexExists.length === 0) {
            ...
            await queryRunner.query(`CREATE INDEX "IDX_student_assignments_class_id" ON "student_assignments" ("class_id") `);
        }
        ...
        if (fkExists.length === 0) {
            ...
            await queryRunner.query(`ALTER TABLE "student_assignments" ADD CONSTRAINT "FK_student_assignments_class_id" FOREIGN KEY ("class_id") REFERENCES "classes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        if (fkExists.length > 0) {
            await queryRunner.query(`ALTER TABLE "student_assignments" DROP CONSTRAINT "FK_student_assignments_class_id"`);
        }
